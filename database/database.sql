...
-- (DATE_ADD(NOW(), INTERVAL 01 DAY) 01, 68, 8, 15, 78, 35, 72, 1, NOW()),
-- (333,14,4,"2020-01"),
-- (333,14,4,"2020-05"),
-- (345,45,3,"2020-06"),
-- (368,86,2,"2020-07"),
...
(03 03, 88, 10, 13, 76, 7, 93, 1, NOW()),
(04 04, 35, 50, 77, 11, 62, 57, 2, NOW()),
(05 05, 96, 59, 15, 73, 16, 74, 2, NOW()),
(06 06, 84, 50, 5, 4, 9, 91, 1, NOW()),
(07 07, 68, 71, 26, 99, 44, 47, 1, NOW()),
(08 08, 13, 41, 89, 2, 52, 90, 1, NOW()),
(09 09, 35, 44, 45, 59, 65, 45, 2, NOW()),
(10 10, 49, 88, 64, 62, 71, 26, 1, NOW()),
(11 11, 81, 41, 13, 1, 88, 74, 1, NOW()),
(12 12, 2, 2, 5, 57, 18, 42, 1, NOW()),
(13 13, 32, 27, 50, 83, 70, 20, 1, NOW()),
(14 14, 12, 10, 5, 25, 19, 36, 2, NOW()),
(15 15, 75, 16, 22, 30, 97, 50, 2, NOW()),
(16 16, 19, 16, 11, 26, 82, 32, 1, NOW()),
(17 17, 66, 47, 81, 48, 44, 31, 1, NOW()),
(18 18, 57, 18, 39, 70, 96, 37, 1, NOW()),
(19 19, 20, 9, 73, 29, 57, 90, 2, NOW()),
(20 20, 23, 56, 40, 35, 7, 13, 2, NOW()),
(21 21, 80, 22, 51, 83, 3, 25, 1, NOW()),
(22 22, 77, 14, 7, 70, 2, 16, 2, NOW()),
(23 23, 68, 10, 30, 87, 25, 36, 1, NOW()),
(24 24, 71, 46, 63, 63, 24, 46, 2, NOW()),
(25 25, 52, 2, 53, 3, 89, 99, 1, NOW()),
(26 26, 33, 35, 65, 28, 24, 51, 1, NOW()),
(27 27, 37, 52, 58, 23, 92, 45, 1, NOW()),
(28 28, 83, 68, 7, 18, 4, 62, 1, NOW()),
(29 29, 85, 40, 74, 30, 4, 91, 1, NOW()),
(30 30, 11, 47, 39, 96, 93, 34, 2, NOW()),
(05 05, 96, 59, 15, 73, 16, 74, 3, NOW()),
(06 06, 84, 50, 5, 4, 9, 91, 3, NOW()),
(07 07, 68, 71, 26, 99, 44, 47, 3, NOW()),
(08 08, 13, 41, 89, 2, 52, 90, 3, NOW()),
(09 09, 35, 44, 45, 59, 65, 45, 3, NOW()),
(21 21, 80, 22, 51, 83, 3, 25, 3, NOW()),
(22 22, 77, 14, 7, 70, 2, 16, 3, NOW()),
(23 23, 68, 10, 30, 87, 25, 36, 3, NOW()),
(24 24, 71, 46, 63, 63, 24, 46, 3, NOW()),
(25 25, 52, 2, 53, 3, 89, 99, 3, NOW()),
(26 26, 33, 35, 65, 28, 24, 51, 3, NOW()),
...
CREATE TRIGGER calculate_evolution_values
AFTER INSERT
...
BEGIN
    ...
    SELECT idMonth FROM monthStat WHERE sourceFileName < var_month_Current ORDER BY sourceFileName DESC LIMIT 1
